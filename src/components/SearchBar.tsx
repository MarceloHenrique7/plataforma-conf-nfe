...
const SearchBar = ({ onSubmit, placeHolder, onReset, searchQuery }: Props) => {
  ...
  return (
    <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className={`flex flex-1 items-center gap-3 justify-between flex-row border-2 w-full rounded-full p-3 ${form.formState.errors.searchQuery && "border-red-500"}`}>

  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="font-bold flex flex-col gap-5">
        ...
        <Link to="/label-page" className="flex items-center justify-between hover:bg-gray-800 hover:text-white transition-all 300-ms bg-gray-200 rounded-md p-2 inline-block">
